...
/* TTS: ~30s of 60ms Opus at max burst without dropping; do not block in WebSocket to apply backpressure. */
#define MAX_DECODE_PACKETS_IN_QUEUE (30 * 1000 / OPUS_FRAME_DURATION_MS)
...
struct AudioServiceCallbacks {
    ...
    std::function<void(const std::string&)> on_sleep_word_detected;
